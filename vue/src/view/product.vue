<template>
    <div class="container mt-4">
        ...
        <div class="row row-container-product">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="/image/produk/produk2.jpg" class="figure-img img-fluid"
                        style="border-radius: 15px; width: 450px;" alt="...">
                    <figcaption class="figure-caption">
                        <a href="" class="text-decoration-none">
                            <img src="/image/produk/produk2.jpg" class="figure-img img-fluid"
                                style="border-radius: 15px; width: 70px;" alt="...">
                        </a>
                        <a href="" class="text-decoration-none">
                            <img src="/image/produk/produk2.jpg" class="figure-img img-fluid"
                                style="border-radius: 15px; width: 70px;" alt="...">
            ...
            <div class="col-lg-7">
                ...
                <RouterLink to="/payment" class="btn btn-outline-dark">BUY</RouterLink>
                ...
                <div class="row d-flex align-content-center align-items-center rounded-3 border shadow-lg">
                    <div class="col-lg-7 p-3 p-lg-5 pt-lg-3 align-content-center">
                        ...
                        <div class="d-grid d-md-flex justify-content-center mt-4 mb-4 mb-lg-3">
                            <button type="button" class="btn btn-outline-dark btn-lg px-4 me-md-2 fw-bold">Hubungi
                                Penjual</button>
                        </div>
                    </div>
                </div>
