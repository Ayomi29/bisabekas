...
<template>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <strong>
                <RouterLink to="/" class="navbar-brand justify-content-center">Home</RouterLink>
            </strong>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <RouterLink to="/login" class="nav-link"><i class="bi bi-box-arrow-in-right"></i> Login</RouterLink>
                    </li>
