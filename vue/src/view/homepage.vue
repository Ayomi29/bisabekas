    ...
    <div class="container mt-4">
        ...
        <div class="container mt-5">
            ...
            <div class="row text-center row-container mt-2">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-category">
                        <a href=""><img src="/image/kategori/elektronik.png" class="img-category mt-3"
                                alt="Electronics"></a>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-category">
                        <a href=""><img src="/image/kategori/hp.png" class="img-category mt-3"
                                alt="Smartphone & Accessories"></a>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-category">
                        <a href=""><img src="/image/kategori/otomotif.png" class="img-category mt-3"
                                alt="Automotive"></a>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-category">
                        <a href=""><img src="/image/kategori/laptop.png" class="img-category mt-3"
                                alt="Computer & Accessories"></a>
                        <p class="mt-2">Computer & Accessories</p>
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-category">
                        <a href=""><img src="/image/kategori/furniture.png" class="img-category mt-3"
                                alt="Furniture"></a>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-category">
                        <a href=""><img src="/image/kategori/accessories.png" class="img-category mt-3"
                                alt="Accessories"></a>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <RouterLink to="/product" class="btn btn-primary d-grid">Buy</RouterLink>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-4 col-6">
