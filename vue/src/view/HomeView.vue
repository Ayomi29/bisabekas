            ...
            <div class="row text-center row-container mt-2">
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-category">
                        <a href=""
                            ><img
                                src="/image/kategori/baju.png"
                                class="img-category mt-3"
                                alt="Clothes"
                        /></a>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-category">
                        <a href=""
                            ><img
                                src="/image/kategori/elektronik.png"
                                class="img-category mt-3"
                                alt="Electronics"
                        /></a>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-category">
                        <a href=""
                            ><img
                                src="/image/kategori/kosmetik.png"
                                class="img-category mt-3"
                                alt="Cosmetic"
                        /></a>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-category">
                        <a href=""
                            ><img
                                src="/image/kategori/otomotif.png"
                                class="img-category mt-3"
                                alt="Automotive"
                        /></a>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-category">
                        <a href=""
                            ><img
                                src="/image/kategori/furniture.png"
                                class="img-category mt-3"
                                alt="Furniture"
                        /></a>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-category">
                        <a href=""
                            ><img
                                src="/image/kategori/accessories.png"
                                class="img-category mt-3"
                                alt="Accessories"
                        /></a>
